...
class SignupHandler:
    ...
    def signup():
            ...
            try:
                ...
                # Validation
                if not all([full_name, dob_str, gender, email, password]):
                ...
                cursor.execute("""
                    INSERT INTO pending_users (photo, user_id, full_name, date_of_birth, gender, phone_number, email, password) 
                    VALUES (%s, %s, %s, %s, %s, %s, %s, %s)
                """, (photo, user_id, full_name, dob_str, gender, phone, email, hashed_pw))
    ...
    def verify_otp():
        ...
        try:
            ...
            if pending:
                cursor.execute("""
                    INSERT INTO users (photo, user_id, full_name, date_of_birth, gender, phone_number, email, password)
                    VALUES (%s, %s, %s, %s, %s, %s, %s, %s)
                """, (pending['photo'], pending['user_id'], pending['full_name'], pending['date_of_birth'], pending['gender'], pending['phone_number'], pending['email'], pending['password']))
